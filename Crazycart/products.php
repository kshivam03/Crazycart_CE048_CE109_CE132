...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Crazycart!</h1>
                    <p>We have the best watches, shirts and pants for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Denim.jpeg" alt="Denim">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Denim Blue</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/PeterEngland.jpeg" alt="Peter England">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Peter England</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Turtle.jpeg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Turtle Grey</h3>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="#">Crazycart</a> Store. All Rights Reserved.</p>
                   <p>This website made by our <a href="team.php">Team</a></p>
